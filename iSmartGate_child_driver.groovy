/**
    ...
    6th Sept 2019 - Removed	capability "Temperature Measurement" from capability section and commented out battery atrribute, 
                    setBattery and setTemperature for use with iSmartGate - not sure if needed but hacked quickly to make it work.
**/
